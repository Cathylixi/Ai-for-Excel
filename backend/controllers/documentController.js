...
async function getDocumentContent(req, res) {
  try {
    ...
    const document = await Document.findById(id)
      .select('originalName fileSize uploadedAt protocolType extractedText sectionedText tables assessmentSchedule parseInfo projectSelectionDetails sdtmAnalysis userConfirmedSdtm sdtmAnalysisStatus');
